package excelReader.demo.read;

import excelReader.util.TestFileUtil;
...
public class ReadTest {
    ...
    public void simpleRead() {
        ...
        // 写法1：
        String fileName = TestFileUtil.getPath() +"excelReader"+File.separator+ "demo" + File.separator + "demo.xlsx";
